...
<xsl:template match="rng:grammar">
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head> 
      <link href="/css/oraccdoc.css" type="text/css" rel="stylesheet"/>
      <title>Oracc Configuration Options</title>
    </head>
    <body>
      <div>
	<ul>
...
<xsl:template mode="case" match="rng:div">
  ...
  <li>
    <a href="{@m:name}.html">
      <xsl:call-template name="tab-label"/> &#x2014;
      <span class="groupdoc"><xsl:value-of select="a:documentation[1]"/></span>
    </a>
  </li>
  -->
  <ex:document href="./configdoc/{@m:name}.html"
	...
	<link href="/css/oraccdoc.css" type="text/css" rel="stylesheet"/>
	<title><xsl:value-of select="@m:name"/> config doco</title>
      </head>
      <body>
	<p>[This page is part of the <a href="/doc/manager/projconfig#Editable_components">Project Configuration documentation</a>]</p>
