...
struct xname anames[] =
{
  ...
  { "g:oivs", "http://oracc.org/ns/gdl/1.0:oivs" },
  ...
  { "g:zwnj", "http://oracc.org/ns/gdl/1.0:zwnj" },
  { "g:zws", "http://oracc.org/ns/gdl/1.0:zws" },
  { "guide", "guide" },
  { "hand", "hand" },
  { "haslinks", "haslinks" },
  { "headform", "headform" },
...
struct attr abases[] =
{
  ...
  { { anames[153].qname,NULL } , { anames[153].pname,NULL } },
