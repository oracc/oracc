...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.17r 2014-03-15 13:55:46 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_ows__call:
		return soap_in_ows__call(soap, NULL, NULL, "ows:call");
	case SOAP_TYPE_ows__Data:
		return soap_in_ows__Data(soap, NULL, NULL, "ows:Data");
	case SOAP_TYPE_xmime5__base64Binary:
		return soap_in_xmime5__base64Binary(soap, NULL, NULL, "xmime5:base64Binary");
	case SOAP_TYPE_PointerToows__Data:
		return soap_in_PointerToows__Data(soap, NULL, NULL, "ows:Data");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ows:call"))
		{	*type = SOAP_TYPE_ows__call;
			return soap_in_ows__call(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ows:Data"))
		{	*type = SOAP_TYPE_ows__Data;
			return soap_in_ows__Data(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE_ows__call:
		return soap_out_ows__call(soap, tag, id, (const struct ows__call *)ptr, "ows:call");
	case SOAP_TYPE_ows__Data:
		return soap_out_ows__Data(soap, tag, id, (const struct ows__Data *)ptr, "ows:Data");
	case SOAP_TYPE_xmime5__base64Binary:
	...
	case SOAP_TYPE_PointerToows__Data:
		return soap_out_PointerToows__Data(soap, tag, id, (struct ows__Data *const*)ptr, "ows:Data");
	case SOAP_TYPE_PointerTostring:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	{
	case SOAP_TYPE_ows__call:
		soap_serialize_ows__call(soap, (const struct ows__call *)ptr);
		break;
	case SOAP_TYPE_ows__Data:
		soap_serialize_ows__Data(soap, (const struct ows__Data *)ptr);
		break;
	case SOAP_TYPE_xmime5__base64Binary:
	...
	case SOAP_TYPE__xop__Include:
		...
		break;
	case SOAP_TYPE_PointerToows__Data:
		soap_serialize_PointerToows__Data(soap, (struct ows__Data *const*)ptr);
		break;
	case SOAP_TYPE_PointerTostring:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ows__call(struct soap *soap, struct ows__call *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ows__call(struct soap *soap, const struct ows__call *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_string(soap, &a->method);
	soap_serialize_PointerTostring(soap, &a->args);
	soap_serialize_PointerToows__Data(soap, &a->in);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ows__call(struct soap *soap, const char *tag, int id, const struct ows__call *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ows__call), type))
		return soap->error;
	if (soap_out_string(soap, "method", -1, &a->method, ""))
		return soap->error;
	if (soap_out_PointerTostring(soap, "args", -1, &a->args, ""))
		return soap->error;
	if (soap_out_PointerToows__Data(soap, "in", -1, &a->in, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

SOAP_FMAC3 struct ows__call * SOAP_FMAC4 soap_in_ows__call(struct soap *soap, const char *tag, struct ows__call *a, const char *type)
{
	size_t soap_flag_method = 1;
	size_t soap_flag_args = 1;
	size_t soap_flag_in = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ows__call *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ows__call, sizeof(struct ows__call), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ows__call(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_args && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTostring(soap, "args", &a->args, "xsd:string"))
				{	soap_flag_args--;
					continue;
				}
			if (soap_flag_in && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToows__Data(soap, "in", &a->in, "ows:Data"))
				{	soap_flag_in--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
	...
	{	a = (struct ows__call *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ows__call, 0, sizeof(struct ows__call), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ows__call(struct soap *soap, const struct ows__call *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ows__call);
	if (soap_out_ows__call(soap, tag?tag:"ows:call", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ows__call * SOAP_FMAC4 soap_get_ows__call(struct soap *soap, struct ows__call *p, const char *tag, const char *type)
{
	if ((p = soap_in_ows__call(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ows__Data(struct soap *soap, struct ows__Data *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ows__Data(struct soap *soap, const struct ows__Data *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ows__Data(struct soap *soap, const char *tag, int id, const struct ows__Data *a, const char *type)
{
	if (a->xmime5__contentType)
		soap_set_attr(soap, "xmime5:contentType", a->xmime5__contentType, 1);
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ows__Data), type))
		return soap->error;
...
SOAP_FMAC3 struct ows__Data * SOAP_FMAC4 soap_in_ows__Data(struct soap *soap, const char *tag, struct ows__Data *a, const char *type)
{
	size_t soap_flag_xop__Include = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ows__Data *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ows__Data, sizeof(struct ows__Data), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ows__Data(soap, a);
	...
	{	a = (struct ows__Data *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ows__Data, 0, sizeof(struct ows__Data), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ows__Data(struct soap *soap, const struct ows__Data *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ows__Data);
	if (soap_out_ows__Data(soap, tag?tag:"ows:Data", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ows__Data * SOAP_FMAC4 soap_get_ows__Data(struct soap *soap, struct ows__Data *p, const char *tag, const char *type)
{
	if ((p = soap_in_ows__Data(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerToows__Data(struct soap *soap, struct ows__Data *const*a)
{
#ifndef WITH_NOIDREF
	if (!soap_reference(soap, *a, SOAP_TYPE_ows__Data))
		soap_serialize_ows__Data(soap, *a);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerToows__Data(struct soap *soap, const char *tag, int id, struct ows__Data *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_ows__Data);
	if (id < 0)
		return soap->error;
	return soap_out_ows__Data(soap, tag, id, *a, type);
}

SOAP_FMAC3 struct ows__Data ** SOAP_FMAC4 soap_in_PointerToows__Data(struct soap *soap, const char *tag, struct ows__Data **a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (struct ows__Data **)soap_malloc(soap, sizeof(struct ows__Data *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = soap_in_ows__Data(soap, tag, *a, type)))
			return NULL;
	}
	else
	{	a = (struct ows__Data **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ows__Data, sizeof(struct ows__Data), 0);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerToows__Data(struct soap *soap, struct ows__Data *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerToows__Data);
	if (soap_out_PointerToows__Data(soap, tag?tag:"ows:Data", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ows__Data ** SOAP_FMAC4 soap_get_PointerToows__Data(struct soap *soap, struct ows__Data **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerToows__Data(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
