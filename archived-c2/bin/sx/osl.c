...
#include "xnn.h"
#include "sl.h"
struct xnn_nstab sl_nstab[] = {
  { sl_n_sl, "xmlns:sl", "http://oracc.org/ns/sl/1.0" },
  { sl_a_enum_top, NULL, NULL },
};

struct xnn_xname sl_anames[] =
{
  { "xmlns:sl", "xmlns:sl" },
  { "xmlns:xml", "xmlns:xml" },
  { "base", "base" },
...
struct xnn_data sl_data = { sl_enames, sl_anames, sl_nstab };
