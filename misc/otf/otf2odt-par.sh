...
### ox -1 is tabular serial; -0 is paragraph serial; -2 is tabular parallel
echo ox -2 -P$project -d$odtdir $driverpath
ox -2 -P$project -d$odtdir $driverpath | xmllint --xinclude - | xsltproc - \
