...
<!-- DOC2 CSS additions SJT : need review for different media? -->
pre.listing { margin-left: 1em; margin-right: 1em;
	      padding-top: 5px; padding-bottom: 5px;
	      padding-left: 2px;
	      background-color: #f5f5dc; color: black; }
pre.example { margin-left: 1em; margin-right: 1em;
	      padding-top: 5px; padding-bottom: 5px;
	      padding-left: 2px;
	      background-color: #eee; color: black; }
pre.cookbook { margin-left: 1em; margin-right: 1em; 
	      padding-top: 5px; padding-bottom: 5px;
	      padding-left: 2px;
	      background-color: #daf3e0; color: black; }

td.cookbook  { background-color: #daf3e0; color: black; vertical-align: middle; }

.cookbook  { background-color: #daf3e0; color: black; }
.example   { background-color: #eee; color: black; }
...
/* END @media block for small viewport sizes */
...
#Content {
	...
	width: 74%;  <!-- check how this width looks in print view: it may need a separate value-->
}
#Header {
	<xsl:if test="contains ( 'screen, handheld', $medium )">
		<xsl:if test="contains ( 'screen', $medium )">
...
/* END @media block for larger viewport sizes */

<!-- named elements that are not @media specific OR have a separate entry in small viewport screens but otherwise are needed in  print format too (eg Breadcrumb) -->
