 ...
 *
 * Modified by Steve Tinney to create data directly in the format needed by Oracc's
 * ESP portal software.
 */
...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			int index = 0;
			System.out.println("<esp:images-info xmlns:esp=\"http://oracc.org/ns/esp/1.0\">");
