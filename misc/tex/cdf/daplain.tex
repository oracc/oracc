...
%
% $Id: daplain.tex,v 0.2 1996/05/27 16:18:16 s Exp $
...
%
% Well, sorry, it's been modified. This is a version of plain which
% has been altered for use as the basis of the Digital Assyriologist
% format. The major changes in this file are in the font definition
% section, output routines and in the hyphen loading. These are 
% excised from plain and dealt with elsewhere in the DA format. Also,
% this file doesn't give the progress messages that plain does.

%%% Triple-commenting is used to indicate excision to accomodate the DA fmt.
...
%\catcode`\_=10 % underscore is used as a visible space
...
\count15=109 % allocates \toks registers 10, 11, ...
...
%%%\mathchardef\sum="1350 % conflicts with sum=sumerian, SJT
\mathchardef\mathsum="1350
...
\newdimen\p@renwd
%%% this had to be changed slightly to avoid the forward reference to 
%%% \tenex---SJT
\def\setp@renwd{\setbox0=\hbox{\tenex B} \p@renwd=\wd0} % width of the big left (
\def\bordermatrix#1{\setp@renwd\begingroup \m@th
...
$Log: daplain.tex,v $
Revision 0.2  1996/05/27 16:18:16  s
*** empty log message ***
