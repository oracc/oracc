...
\def\reallyMaybeEject#1#2{
   \calcpagetotal
   \wlog{computed \calcedpagetotal=\the\calcedpagetotal; \vsize=\the\vsize; \pageshrink=\the\pageshrink}%
...
%       \showthe\footnoteSize
       ...
       \ifdim\calcedpagetotal < .5\pageshrink %\pageshrink % hack!
         \doMaybeEject
       \else
         #2
       \fi
...
\def\introductionb{\parskip\baselineskip}
...
\showboxbreadth10000 \showboxdepth10000 \tracingoutput1
